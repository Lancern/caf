...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @_Z17getFromObjectListi(i32 %objIdx) #3 {
entry:
  %retval = alloca i64, align 8
  %objIdx.addr = alloca i32, align 4
  store i32 %objIdx, i32* %objIdx.addr, align 4
  %0 = load i32, i32* %objIdx.addr, align 4
...
if.end:                                           ; preds = %entry
  %1 = load i32, i32* %objIdx.addr, align 4
  %conv1 = sext i32 %1 to i64
  %call2 = call dereferenceable(8) i64* @_ZNSt6vectorIlSaIlEEixEm(%"class.std::vector"* @__caf_object_list, i64 %conv1) #4
